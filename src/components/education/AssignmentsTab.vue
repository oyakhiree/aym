...
<template>
  <div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <h3 class="text-lg font-bold text-secondary-900 leading-tight">
          Assignments & Grades
        </h3>
        <p class="text-xs text-secondary-500 font-medium mt-1">
          Manage classwork and homework scores
        </p>
      </div>
      <BaseButton
    ...
    <div class="hidden md:block bg-white rounded-2xl border border-secondary-100 shadow-sm overflow-hidden flex flex-col relative h-[500px]">
      <div class="overflow-auto flex-1 custom-scrollbar">
        <table class="min-w-full text-left border-collapse">
            ...
            <tr>
              ...
              >
                <div class="flex flex-col items-center">
                  <span
                    class="text-sm font-bold text-secondary-800 line-clamp-1 px-2"
                    :title="assign.title"
                  >{{ assign.title }}</span>
          ...
          <tbody class="divide-y divide-secondary-50 bg-white">
            <tr
              ...
              :key="student.id"
              class="group hover:bg-secondary-50/30 transition-colors"
            >
        ...
        >
          ...
          <h4 class="text-secondary-900 font-bold mb-1">
            No assignments yet
          </h4>
          <p class="text-secondary-500 text-sm max-w-xs">
    ...
    <div class="md:hidden space-y-4">
      ...
      >
        ...
        >
          ...
          >
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[10px] text-secondary-500">
                {{ assign.type }} • Max {{ assign.maxScore }}
              </p>
            </div>
          ...
          <div
            v-if="assignments.length === 0"
            class="text-center py-4 text-secondary-500 text-sm"
          >
      ...
      <div
        ...
        class="text-center py-12 text-secondary-500 text-sm"
      >
