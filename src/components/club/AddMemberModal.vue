          ...
          >
            <div v-if="isOpen" class="relative w-full transform overflow-hidden rounded-t-2xl sm:rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:max-w-2xl border-t sm:border border-secondary-100 max-h-[90vh] sm:max-h-none overflow-y-auto">
              ...
              <div class="bg-secondary-50/50 px-6 py-4 border-b border-secondary-100 flex items-center justify-between">
                <div>
                   <h3 class="text-lg font-bold text-secondary-900 leading-6" id="modal-title">New Member Registration</h3>
                   <p class="text-sm text-secondary-500 mt-0.5">Add a new pathfinder or adventurer to your club roster.</p>
                </div>
              ...
              <div class="px-6 py-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input v-model="form.firstName" type="text" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3" placeholder="e.g. John">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-sm font-medium text-secondary-700">Last Name <span class="text-red-500">*</span></label>
                            <input v-model="form.lastName" type="text" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3" placeholder="e.g. Doe">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input v-model="form.dob" type="date" class="block w-full rounded-xl border-secondary-200 pl-10 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3">
                            </div>
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-sm font-medium text-secondary-700">Gender</label>
                            <select v-model="form.gender" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3">
                                <option>Male</option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <select v-model="form.class" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="flex items-center gap-3 pt-2">
                                ...
                                <span class="text-sm font-medium" :class="form.status ? 'text-emerald-600' : 'text-secondary-500'">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input v-model="form.guardian" type="text" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3" placeholder="Parent/Guardian Full Name">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input v-model="form.phone" type="tel" class="block w-full rounded-xl border-secondary-200 pl-10 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3" placeholder="+234...">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-secondary-50 border border-dashed border-secondary-300 rounded-xl p-4 flex flex-col items-center justify-center text-center hover:bg-secondary-100 transition-colors cursor-pointer group">
                    <div class="p-3 bg-white rounded-full shadow-sm mb-2 group-hover:scale-110 transition-transform">
                     ...
                     <p class="text-sm font-medium text-secondary-900">Upload Birth Certificate</p>
                    <p class="text-xs text-secondary-500 mt-1">SVG, PNG, JPG or PDF (MAX. 800x400px)</p>
                </div>
              </div>
