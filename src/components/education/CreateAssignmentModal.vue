    ...
    >
      <div v-if="isOpen" class="fixed inset-0 z-50 flex justify-center sm:block" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex flex-col justify-end min-h-screen sm:min-h-full sm:items-center sm:justify-center p-0 sm:p-4 text-center w-full">
          ...
          >
            <div v-if="isOpen" class="relative w-full transform overflow-hidden rounded-t-2xl sm:rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:max-w-md border-t sm:border border-secondary-100">
                
              <!-- Header -->
              <div class="bg-secondary-50/50 px-6 py-4 border-b border-secondary-100 flex items-center justify-between">
                <div>
                   <h3 class="text-lg font-bold text-secondary-900 leading-6">New Assignment</h3>
                </div>
              ...
              <div class="px-6 py-6 space-y-5">
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5">
                        ...
                        <input v-model="form.title" type="text" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3" placeholder="e.g. Memory Verse Psalm 23">
                    </div>

                    <div class="space-y-1.5">
                        <label class="text-sm font-medium text-secondary-700">Max Score</label>
                        <input v-model="form.maxScore" type="number" class="block w-full rounded-xl border-secondary-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5 px-3">
                    </div>
                </div>
